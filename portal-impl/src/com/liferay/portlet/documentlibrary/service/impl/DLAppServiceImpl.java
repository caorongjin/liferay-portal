...
public class DLAppServiceImpl extends DLAppServiceBaseImpl {
	...
	public void cancelCheckOut(long fileEntryId)
		...
		dlAppHelperLocalService.updateFileEntry(
			getUserId(), fileEntry, fileEntry.getFileVersion(), null,
			serviceContext);
	}
	...
	public void checkInFileEntry(
		...
		dlAppHelperLocalService.updateFileEntry(
			getUserId(), fileEntry, fileVersion, oldFileVersion,
	...
	public void checkOutFileEntry(
		...
		dlAppHelperLocalService.updateFileEntry(
			getUserId(), fileEntry, fileVersion, oldFileVersion, fileEntryId);
	}
	...
	public FileEntry updateFileEntry(
		...
		dlAppHelperLocalService.updateFileEntry(
			...
			oldFileEntry.getFileVersion(), serviceContext);
